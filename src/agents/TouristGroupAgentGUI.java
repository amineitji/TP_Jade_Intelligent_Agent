...
/**
 * Version modifiée du TouristGroupAgent avec intégration GUI
 */
public class TouristGroupAgentGUI extends Agent {
    ...
    protected void setup() {
        ...
        gui.addGroup(groupId, nationality, groupSize);
        gui.updateGroupStatus(groupId, "EN_ATTENTE");
        ...
        addBehaviour(new ReceiveGuideInfoBehaviourGUI());
        addBehaviour(new GroupInteractionBehaviourGUI());
    }
    ...
    private void registerInYellowPages() {
        ...
        sd.setName("Groupe de touristes GUI");
        dfd.addServices(sd);
        try {
        ...
        public void action() {
            ...
            if (reply != null) {
                if (reply.getPerformative() == ACLMessage.AGREE) {
                    ...
                    // Notification GUI
                    gui.updateGroupStatus(groupId, "ASSIGNE_GUIDE");
    ...
    // Comportement pour recevoir les informations du guide avec GUI
    private class ReceiveGuideInfoBehaviourGUI extends CyclicBehaviour {
        @Override
        public void action() {
        ...
        private void handleTableauInfo(String content) {
            ...
            if (parts.length >= 4 && parts[1].equals(groupId)) {
                ...
                // Notification GUI
                if (visitedTableaux.size() == 1) {
                    gui.updateGroupStatus(groupId, "EN_VISITE");
                }
        ...
        private void handleTourFinished(String content) {
            ...
            if (parts.length >= 2 && parts[1].equals(groupId)) {
                ...
                // Notification GUI
                gui.updateGroupStatus(groupId, "VISITE_TERMINEE");
                
                // Programmer la suppression du groupe après un délai
                addBehaviour(new WakerBehaviour(myAgent, 5000) {
                    @Override
                    protected void onWake() {
                        doDelete(); // Supprimer l'agent groupe
                    }
                });
            }
        }
    ...
    // Comportement pour les interactions internes du groupe avec GUI
    private class GroupInteractionBehaviourGUI extends TickerBehaviour {
        public GroupInteractionBehaviourGUI() {
            super(TouristGroupAgentGUI.this, 20000); // Toutes les 20 secondes
        }
        ...
        private void simulateGroupDynamics() {
            ...
            if (Math.random() < 0.7) {
                ...
                System.out.println("🎭 Dynamique de groupe " + groupId + ": " + dynamic);
            }
        }
    }
    
    // Getters pour l'interface GUI
